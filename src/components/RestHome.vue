			...
			<v-col cols="12">
				<v-form>
					<v-container>
						...
						<v-btn large color="primary" @click="getOneStat()"
							>Get One Specific User</v-btn
						>
					</v-container>
				</v-form>
				<v-container>
					<div>
						<v-row>
							<v-col cols="3">
								<v-card class="mx-auto" max-width="350">
									<v-card-text>
										<p class="name"><strong>ID:</strong>{{ oneStat._id }}</p>
										<p><strong>KD:</strong>{{ oneStat.KD }}</p>
										<p><strong>GamerTag:</strong>{{ oneStat.gamerTag }}</p>
										<p>
											<strong>Matches Played:</strong
											>{{ oneStat.matchesPlayed }}
										</p>
										<p><strong>Platform:</strong>{{ oneStat.platform }}</p>
									</v-card-text>
								</v-card>
							</v-col>
						</v-row>
			...
			<v-col cols="12">
				<v-form>
					<v-container>
						...
						<v-btn large color="primary" @click="createGamer()"
							>Create Gamer</v-btn
						>
					</v-container>
				</v-form>
				...
				<v-form>
					<v-container>
						...
						<v-row>
							...
							<v-col cols="6" md="6">
								<v-text-field
									v-model="updateGamerTag"
									label="Update Gamertag?"
									required
									filled
								></v-text-field>
							</v-col>
						...
						<v-btn large color="primary" @click="EditStat()"
							>Update Gamer</v-btn
						>
					</v-container>
				</v-form>
			...
			<v-col cols="12">
				<v-form>
					<v-container>
						...
						<v-btn large color="primary" @click="removeGamer()"
							>Remove Gamer</v-btn
						>
					</v-container>
				</v-form>
